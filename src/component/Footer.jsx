...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 text-gray-800 py-10 px-6 md:px-16 mt-0 pt-50 overflow-x-hidden">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 border-b border-t pt-8 md:pt-18 border-gray-300 pb-10">
        
        {/* ABOUT SECTION */}
        <div className="mt-0 md:-mt-62">
        ...
        <div className="mt-0 md:-mt-16">
          ...
          {/* <div className="flex items-start gap-3 text-base font-nunito text-gray-600 mb-4">
            ...
            <p className="leading-relaxed">
              Barki Bashouli,<br />
              Barki Basauli Branch Post Office,<br />
          ...
          <div className="flex items-center gap-3 text-base font-nunito text-gray-600 mb-4">
            ...
            <p className="break-all">{VTS_SUPPORT.email}</p>
          </div>
        ...
        <div className="mt-0 md:-mt-16">
          ...
          <div className="flex space-x-4 text-gray-600 text-xl">
            <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/@fixWithvikas"><FaYoutube className="hover:text-red-600 cursor-pointer" /></a>
            <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=61575266311355"><FaFacebookF className="hover:text-red-600 cursor-pointer" /></a>
            <a target="_blank" rel="noopener noreferrer" href="https://x.com/VikashDube9198"><FaTwitter className="hover:text-red-600 cursor-pointer" /></a>
            <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/vikash_tech_solution/"><FaInstagram className="hover:text-red-600 cursor-pointer" /></a>
