...
const RegistrationPopup = ({ event, onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black/60 backdrop-blur-sm flex justify-center items-center z-50">
      <div
        className="relative bg-white rounded-3xl shadow-2xl p-8 w-[90%] sm:w-[60%] md:w-[40%]   max-h-[85vh] overflow-y-auto transform transition-all duration-300 scale-100 animate-fadeIn"
        style={{
