...
const outcomes = {
  ...
  macro: {
    ...
    roles: [
      ...
      "Frontend Architect (React.js)",
      "Backend Engineer (Node.js)",
      "JavaScript Engineer",
      "Technical Lead (Entry-Level)",
    ...
    <section className="bg-[#fff] py-20 px-6">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="bg-[linear-gradient(to_bottom,#FFF_20%,#FBEAEB_80%)]  h-99 rounded-xl p-8 relative overflow-hidden shadow-sm">
        ...
        <div>
          ...
          <div className="bg-[linear-gradient(to_bottom,#FFF_20%,#FBEAEB_80%)] rounded-xl p-8 relative overflow-hidden shadow-sm">
            ...
            {/* Ribbon */}
            <div className="absolute right-[-80px] top-[40px] rotate-45 bg-blue-100 text-blue-700 px-20 py-1 text-sm w-">
          ...
          <div className="bg-white border border-red-200 mt-6 rounded-xl font-serif p-4 shadow-sm">
            ...
            <span className="text-red-700 mr-4">
